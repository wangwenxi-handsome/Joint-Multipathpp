...
def main():
    ...
    from test import parse_scenario_data, parse_tfexample_data
    ...
    for shard_filename in ["/root/competition/waymo_sim_agent/tools/uncompressed_tf_example_validation_validation_tfexample.tfrecord-00000-of-00150"]:
        ...
        scenario_rollouts = []
        for scenario_id in tqdm(parse_tfexample_data(shard_filename)):
